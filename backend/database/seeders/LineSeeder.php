...
class LineSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $lines = [
            ...
            ['number' => '706', 'vehicle' => 'Bus', 'start_location' => 'Zeleni Venac', 'end_location' => 'Batajnica', 'duration' => '48 min', 'price' => '50 RSD','number_of_stops'=>'25'],
            ...
            ['number' => '9L', 'vehicle' => 'Tram', 'start_location' => 'Novi Beograd/Blok 45', 'end_location' => 'Trg Slavija/Nemanjina', 'duration' => '40 min', 'price' => '50 RSD','number_of_stops'=>'23'],
            ['number' => '14L', 'vehicle' => 'Tram', 'start_location' => 'Ustanička - Resavska', 'end_location' => 'Trg Slavija - Ustanička', 'duration' => '37 min', 'price' => '50 RSD','number_of_stops'=>'27'],
